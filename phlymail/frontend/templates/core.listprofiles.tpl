...
function saveprofile()
{
    ...
    if (ssl_available == 0) {
        ...
        if (form.popserver.value.substr(0, 6) == 'ssl://') {
            if (error == false) alert((acctype == 'imap') ? '{msg_nossl_imap}' : '{msg_nossl_pop3}');
            error = true;
        }
    }
...
function store_profile_order()
{
    ...
    $.ajax({ url: orders, success: function () {
        opener.frames.PHM_tl.setTimeout("flist_refresh('email')", 1);
    }});
}
    ...
    <div class="sendmenubut sendmenuborder" style="width:200px;height:246px;overflow:auto;float:left;margin:0 4px 0 0;">
        <ul id="core_accountslist_sortable"><!-- START menline -->
            <li id="prof_{id}" style="cursor:pointer;" onclick="loadprofile({id});" title="{profilenm}">
                ...
                <img class="protocol_icon" src="{theme_path}/icons/proto_pop3.gif" alt="" title="POP3" /><!-- END acctype_pop3 --><!-- START acctype_imap -->
                <img class="protocol_icon" src="{theme_path}/icons/proto_imap.gif" alt="" title="IMAP" /><!-- END acctype_imap -->
                {profilenm}
            </li><!-- END menline -->
        </ul>
    </div>
                ...
                <div id="tabpane" class="ui-tabpane" style="height:226px;">
                    ...
                    <div id="advancedfields">
                        ...
                        <select size="1" name="checkevery" id="checkevery" class="r">
                            <option value="0">%h%FetchManual%</option>
                            <option value="5">5&thinsp;min</option>
                            <option value="10">10&thinsp;min</option>
                            <option value="15">15&thinsp;min</option>
                            <option value="30">30&thinsp;min</option>
                            <option value="60">1&thinsp;h</option>
                            <option value="120">2&thinsp;h</option>
                            <option value="240">4&thinsp;h</option>
                            <option value="360">6&thinsp;h</option>
                            <option value="480">8&thinsp;h</option>
                            <option value="720">12&thinsp;h</option>
                            <option value="1440">24&thinsp;h</option>
                        </select>
                        <br />
                        <br />
                        <input type="checkbox" id="lbl_sigon" name="sig_on" value="1" />
                        <label for="lbl_sigon"><strong>{msg_sigon}</strong></label><br />
                        <div style="float:right;width:20px;padding:4px;text-align:left;vertical-align:top;height:130px;">
                        ...
                        <div class="sendmenuborder" id="sigpreview" style="float:right;width:265px;height:130px;overflow:auto;"></div>
                        <div class="sendmenuborder" id="sigcontain" style="width:200px;height:130px;overflow:auto;">
                        </div>
                    </div>
                </div>
